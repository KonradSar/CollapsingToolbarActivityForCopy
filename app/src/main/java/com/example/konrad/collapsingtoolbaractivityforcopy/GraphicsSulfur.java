...
public class GraphicsSulfur extends AppCompatActivity {
    private float[] yData = NaszeMEtody.listOfValuesForSO;
    private String[] xData = NaszeMEtody.listOfDataAndTimeValForSO;
    BarChart barChart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_graphics_sulfur);
        barChart = (BarChart) findViewById(R.id.pieChartSO);
        barChart.getDescription().setEnabled(false);
        barChart.getLegend().setEnabled(false);
        setUpPieCharts();
        TextView textView;
        textView = (TextView) findViewById(R.id.graphicDesc);
        textView.setText("Concentration of SO2 measurements in the air [\u00B5g]/m3 (Standard concentration is below 200 [\u00B5g]/m3)");
    ...
    private void setUpPieCharts() {
        ...
        int maxCapacity = 200;
        LimitLine limitLineForGraphic = new LimitLine(maxCapacity, "Max Value for SO2 is 200 "+"\u00B5"+"g/m3");
