...
public class GraphicsNitro extends AppCompatActivity {
    private float[] yData = NaszeMEtody.listOfValuesForNO;
    private String[] xData = NaszeMEtody.listOfDataAndTimeValForNO;
    BarChart barChart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_graphics_nitro);
        barChart = (BarChart) findViewById(R.id.pieChartNO);
        barChart.getDescription().setEnabled(false);
        barChart.getLegend().setEnabled(false);
        setUpPieCharts();
        TextView textView;
        textView = (TextView) findViewById(R.id.graphicDesc);
        textView.setText("Concentration of NO2 measurements in the air [\u00B5g]/m3 (Standard concentration is below 150 [\u00B5g]/m3)");
    ...
    private void setUpPieCharts() {
        ...
        int maxCapacity = 150;
        LimitLine limitLineForGraphic = new LimitLine(maxCapacity, "Max Value for NO2 is 150 "+"\u00B5"+"g/m3");
