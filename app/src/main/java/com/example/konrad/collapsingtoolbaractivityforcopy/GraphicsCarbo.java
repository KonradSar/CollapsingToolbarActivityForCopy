...
public class GraphicsCarbo extends AppCompatActivity {
    private float[] yData = NaszeMEtody.listOfValuesForCO;
    private String[] xData = NaszeMEtody.listOfDataAndTimeValForCO;
    BarChart barChart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_graphics_carbo);
        barChart = (BarChart) findViewById(R.id.pieChartCO);
        barChart.getDescription().setEnabled(false);
        barChart.getLegend().setEnabled(false);
        setUpPieCharts();
        TextView textView;
        textView = (TextView) findViewById(R.id.graphicDesc);
        textView.setText("Concentration of CO measurements in the air [\u00B5g]/m3 (Standard concentration is below 11 [\u00B5g]/m3)");
    ...
    private void setUpPieCharts() {
        ...
        int maxCapacity = 10;
        LimitLine limitLineForGraphic = new LimitLine(maxCapacity, "Max Value for CO is 10 "+"\u00B5"+"g/m3");
