...
public class GraphicsPM10 extends AppCompatActivity {
    private float[] yData = NaszeMEtody.listOfValuesForPM10;
    private String[] xData = NaszeMEtody.listOfDataAndTimeValForPM10;
    BarChart barChart;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_graphics_pm10);
        barChart = (BarChart) findViewById(R.id.pieChartPMTen);
        barChart.getDescription().setEnabled(false);
        barChart.getLegend().setEnabled(false);
        setUpPieCharts();
        TextView textView;
        textView = (TextView) findViewById(R.id.graphicDesc);
        textView.setText("Concentration of PM10 measurements in the air [\u00B5g]/m3 (Standard concentration is below 100 [\u00B5g]/m3)");
    ...
    private void setUpPieCharts() {
        ...
        int maxCapacity = 100;
        LimitLine limitLineForGraphic = new LimitLine(maxCapacity, "Max Value for PM10 is 100 "+"\u00B5"+"g/m3");
